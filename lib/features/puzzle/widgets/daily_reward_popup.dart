...
class _DailyRewardPopupState extends State<DailyRewardPopup>
  ...
  // الوهج يظهر حول الصندوق عندما تكون المكافأة متاحة
  ...
  Future<void> _updateDailyRewardStatus() async {
    try {
      ...
      //==================================================
      // ⏱️ الوقت المتبقي من 24 ساعة منذ آخر استلام
      //==================================================
  ...
  Future<void> _onBoxTap() async {
    ...
    if (firstReward) {
      ...
      //==================================================
      // ⏱️ بدء 24 ساعة من لحظة مكافأة البداية
      //==================================================
