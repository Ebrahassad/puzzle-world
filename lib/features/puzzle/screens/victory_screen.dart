...
class _VictoryCinematicScreenState
  ...
  final Map<PuzzlePiece, _ExplosionData>
      _explosionData = {};
        ...
        children: [
            ...
            (context,child){
              ...
              return Transform.translate(
                ...
                Transform.scale(
                  ...
                  scale:
                  _finalGemSequence ? _gemChestScale.value : _chestScale.value,
                  ...
                  Transform.rotate(
                    ...
                    angle:
                    _finalGemSequence ? 0 : _chestShake.value,
          ...
          AnimatedBuilder(
            ...
            (context,child){
              ...
              final currentScale =
                  1.0 - (_rewardController.value * 0.35);
...
class PuzzleExplosionPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(
      covariant PuzzleExplosionPainter oldDelegate) {
